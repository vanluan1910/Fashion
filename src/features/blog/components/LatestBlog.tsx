...
export function LatestBlog() {
  ...
  return (
    <section className="pt-[30px] md:pt-[60px] bg-white overflow-hidden pb-[40px]">
                ...
                <div className="flex flex-col group">
                  ...
                  <div className="blog_content">
                    ...
                    <Link href={`/blog/${blog.slug}`} className="block mb-4">
                      <h5 className="text-[20px] font-bold text-[#333] hover:text-[#f74f2e] transition-colors leading-tight line-clamp-1">
                        {blog.title}
                      </h5>
                    </Link>
