...
function TableActionMenu({
  ...
  const mergeTableCellsAtSelection = () => {
    // Note: $mergeCells is not available in current @lexical/table version
    // This functionality may need to be implemented differently
    // For now, we'll disable the merge cells feature
    console.warn('Merge cells functionality is not available in current Lexical version');
    onClose();
  };
  ...
  const toggleFirstRowFreeze = useCallback(() => {
    // Note: setFrozenRows/getFrozenRows methods are not available in current TableNode
    // This functionality is disabled
    console.warn('Freeze rows functionality is not available in current Lexical version');
    onClose();
  }, [onClose]);

  const toggleFirstColumnFreeze = useCallback(() => {
    // Note: setFrozenColumns/getFrozenColumns methods are not available in current TableNode
    // This functionality is disabled
    console.warn('Freeze columns functionality is not available in current Lexical version');
    onClose();
  }, [onClose]);
  ...
  const formatVerticalAlign = (value: string) => {
    // Note: setVerticalAlign method is not available in current TableCellNode
    // This functionality is disabled
    console.warn('Vertical align functionality is not available in current Lexical version');
  };
